...
if [[ "0.1.5" != "/Users/rmalik/dev/xchammer/.build/debug/XCHammer --version" ]]; then 
...
PREV_STAT=`stat -f %c "/Users/rmalik/dev/xchammer/sample/UrlGet/UrlGet.xcodeproj/XCHammerAssets/genStatus"`
...
STAT=`stat -f %c "/Users/rmalik/dev/xchammer/sample/UrlGet/UrlGet.xcodeproj/XCHammerAssets/genStatus"`
